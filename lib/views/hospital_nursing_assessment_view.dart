...
import '../widgets/hospital/student_info_card.dart';
import '../widgets/hospital/criteria_card.dart';
import '../widgets/hospital/bottom_button.dart';
import '../controllers/assessment_controller.dart';

class HospitalNursingAssessmentView extends StatefulWidget {
  const HospitalNursingAssessmentView({super.key});

  @override
  State<HospitalNursingAssessmentView> createState() => _HospitalNursingAssessmentViewState();
}

class _HospitalNursingAssessmentViewState extends State<HospitalNursingAssessmentView> {
  ...
  final Map<String, List<int>> scoreOptions = {
    'Aspecto Cognitivo': [0, 2, 4, 5],
    'Aspecto Procedimental': [0, 2, 3, 4],
  ...
  Future<void> _loadAspectData() async {
    try {
      final String jsonString = await DefaultAssetBundle.of(context).loadString(
        'assets/json/hospital_nursing.json',
      );
